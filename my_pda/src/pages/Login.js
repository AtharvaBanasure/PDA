...
const Login = (props) => {
    ...
    const handleLogout = () => {
        ...
        setIsLoggedIn(false); // Set isLoggedIn to false upon logout using setIsLoggedIn
    ...
    const handleSubmit = async (event) => {
        ...
        .then(data => {
            ...
            setIsLoggedIn(true); // Set isLoggedIn to true upon successful login using setIsLoggedIn
                ...
                <div class="py-16 mt-12">
                    <div class="flex bg-white rounded-lg shadow-lg overflow-hidden mx-auto max-w-sm lg:max-w-4xl">
                        ...
                        <div class="w-full p-8 lg:w-1/2">
                            ...
                            {isLoggedIn ? (
                                    <button onClick={handleLogout} className="bg-[#426B1F] hover:bg-[#486a2a] text-white font-bold py-2 px-4 w-full rounded">Logout</button>
                                ) : (
                                    <>
                                    ...
                                    <div class="mt-8">
                                        <button type="submit" onClick={handleSubmit} className="bg-[#426B1F] hover:bg-[#486a2a] text-white font-bold py-2 px-4 w-full rounded">Login</button>
                                    </div>
                                    <div class="mt-4 flex items-center justify-between">
